...
export PATH=$PATH:~/scripts/:~/prog/68k/68k_tools/:~/.local/bin:/home/bobthehuge/.local/share/coursier/bin:/usr/local/jdk/graalvm-jdk-22/bin:$DOTNET_ROOT:$DOTNET_ROOT/tools
